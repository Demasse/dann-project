...
<header class="bg-gray-800 py-4 flex flex-col shadow-md col-span-1 h-[100vh]">
    <nav class="container mx-auto">
        <ul class="flex flex-col h-full">

            {{-- Dashboard pour admin et enseignant --}}
            @if (Auth::user()->role === 'admin' || Auth::user()->role === 'enseignant')
                <li class="flex items-center space-x-1 py-2 hover:bg-[#d7d7ec]">
                    <a class="text-white font-bold text-lg" href="{{ route('begin.acceuil') }}">Dashboard</a>
                </li>
            @endif
            ...
            @php
                $menuItems = [
                    'admin' => [
                        ['route' => 'cours.index', 'label' => 'Liste des cours', 'icon' => ''],
                        ['route' => 'cours.create', 'label' => 'Créer un cours', 'icon' => ''],
                        ['route' => 'module.create', 'label' => 'Créer un module', 'icon' => ''],
                        ['route' => 'prog.create', 'label' => 'Programmer un cours', 'icon' => ''],
                        ['route' => 'user.index', 'label' => 'Liste des utilisateurs', 'icon' => ''],
                        ['route' => 'user.prof', 'label' => 'Liste des professeurs', 'icon' => ''],
                        ['route' => 'user.etudiant', 'label' => 'Liste des étudiants', 'icon' => ''],
                        ['route' => 'prog.index', 'label' => 'Emploi de temps', 'icon' => ''],
                    ],
                    'enseignant' => [
                        ['route' => 'cours.index', 'label' => 'Liste des cours', 'icon' => ''],
                        ['route' => 'cours.create', 'label' => 'Créer un cours', 'icon' => ''],
            ...
            @foreach ($menuItems[Auth::user()->role] ?? [] as $item)
                <li class="flex items-center space-x-1 py-2 hover:bg-[#d7d7ec]">
                    <a class="text-white font-bold text-lg" href="{{ route($item['route']) }}">{{ $item['label'] }}</a>
                </li>
            @endforeach

            {{-- Ajouter utilisateur pour admin --}}
            @if (Auth::user()->role === 'admin')
                <li class="flex items-center space-x-1 py-2 mt-[14rem] hover:bg-[#d7d7ec]">
                    <a class="text-white font-bold text-lg" href="{{ route('user.create') }}">Ajouter un utilisateur</a>
                </li>
            @endif

            {{-- Déconnexion --}}
            <li class="flex items-center space-x-1 py-2 hover:bg-[#d7d7ec]">
                <a class="text-white font-bold text-lg" href="{{ route('logout') }}">Déconnexion</a>
            </li>
