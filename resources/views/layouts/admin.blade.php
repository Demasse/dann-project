        ...
        <nav class="container mx-auto ">
            ...
            <ul class="flex justify-center space-x-4 flex-col h-[100%] ">
                ...
                <li class="flex items-center space-x-1 py-2">
                    ...
                    <a class="text-white hover:text-red-200 font-bold text-lg" href="{{ route('begin.acceuil') }}">
                        Dashboard
                    </a>
                </li>
                ...
                <li class="flex items-center space-x-1 py-2">
                    ...
                    <a class="text-white hover:text-red-200 font-bold text-lg" href="{{ route('cours.index') }}">liste des cours</a>
                </li>
                ...
                <li class="flex items-center space-x-1 py-2">
                    ...
                    <a class="text-white hover:text-red-200 font-bold text-lg" href="{{ route('user.index') }} ">Liste des utilisateur</a>
                </li>
                ...
                <li class="flex items-center space-x-1 py-2">
                    ...
                    <a class="text-white hover:text-red-200 font-bold text-lg" href="{{ route('user.prof') }} ">Liste des professeurs</a>
                </li>
                ...
                <li class="flex items-center space-x-1 py-2">
                    ...
                    <a class="text-white hover:text-red-200 font-bold text-lg" href="{{ route('user.etudiant') }} ">Liste des etudiants</a>
                </li>
            ...
            <li class="flex items-center space-x-1 py-2 mt-[16rem]">
                ...
                <a class="text-white hover:text-red-200 font-bold text-lg" href="{{ route('logout') }}" >Deconnecte </a>
            </li>
