...
@section('content')
    <div class="col-span-4">
            ...
            <h1 class="text-2xl text-center px-4 py-2 font-bold text-white bg-gradient-to-r from-red-500 to-black rounded-md hover:opacity-80 transition-opacity duration-300">Liste des etudiants</h1>
        <br>
        <br>
