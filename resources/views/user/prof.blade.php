...
<div class="col-span-4">
    ...
    <h1 class=" text-2xl text-center   px-4 py-2 font-bold text-white bg-gradient-to-r from-blue-500 to-green-500 rounded-md hover:opacity-80 transition-opacity duration-300">Listes des professeur</h1>
<br>
<br>
   ...
   <ul></ul>
    ...
    <table class="min-w-full bg-white rounded-lg shadow-lg">
        ...
        <tbody>
            ...
            @foreach ($profcounts as $profcount )
        <tr>
            <td class="py-2 px-4">{{ $profcount->name }}</td>
            <td class="py-2 px-4">{{ $profcount->email }}</td>
            <td class="py-2 px-4">{{ $profcount->role }}</td>
