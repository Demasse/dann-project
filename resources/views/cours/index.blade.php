...
<div class="col-span-4">
    ...
    <h1 class="text-2xl text-center px-4 py-2 font-bold  text-white bg-gradient-to-r from-red-500 to-black rounded-md duration-300">Liste des cours</h1>

 <br>
 <br>

 @if (session('success'))
 <div class="alert alert-success text-white bg-green-700 h-8 ">
     {{ session('success') }}
 </div>
 <br>
